 ...
 */
#define INPUT_SHAPING_X // BFS 2024-02-05
#define INPUT_SHAPING_Y // BFS 2024-02-05
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. // BFS 2024-02-10
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu // BFS 2024-02-07
...
#define SET_PROGRESS_MANUALLY // BFS 2024-02-05
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // Display estimated time to completion (prefix 'R')  // BFS 2024-02-07
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // BFS 2024-02-07
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' // BFS 2024-02-07
...
#define BABYSTEPPING
  ...
  #define USE_PROBE_FOR_Z_HOMING          // Combine M851 Z and Babystepping
 ...
 */
#define LIN_ADVANCE // BFS 2024-02-05
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 64 // BFS 2024-02-07
#else
  #define BLOCK_BUFFER_SIZE 64 // BFS 2024-02-07
#endif
...
#define BUFSIZE 16 // BFS 2024-02-07
...
#define TX_BUFFER_SIZE 32 // BFS 2024-02-07

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 2048 // BFS 2024-02-07

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF // BFS 2024-02-07
#endif
...
*/
#define EMERGENCY_PARSER // BFS 2024-02-07
...
#define ADVANCED_OK  // BFS 2024-02-07
 ...
 */
#define AUTO_REPORT_POSITION // BFS 2024-02-07
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations  // BFS 2024-02-07
#define M114_REALTIME       // Real current position based on forward kinematics  // BFS 2024-02-07
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others)  // BFS 2024-02-07
...
#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback  // BFS 2024-02-07
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM          // Add a menu item that tells the host to start  // BFS 2024-02-07
